    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 animate-reveal delay-300">
            ...
            <div class="bg-surface-container-lowest border border-outline-variant/30 rounded-2xl p-8 ">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="razon_social" value="<?= $nombre ?>" required class="w-full bg-surface-container-low border border-outline-variant/50 text-slate-900 rounded-xl px-4 py-3 text-sm focus:border-primary outline-none transition-all">
                    </div>
                    <div>
                        <label class="block text-[10px] font-black text-on-surface-variant uppercase tracking-widest mb-2 ml-1">RFC</label>
                        <input type="text" name="rfc" value="<?= $rfc ?>" required class="w-full bg-surface-container-low border border-outline-variant/50 text-slate-900 rounded-xl px-4 py-3 text-sm focus:border-primary outline-none transition-all">
                    </div>
                    <div>
                        ...
                        <input type="email" name="email" value="<?= $email ?>" required class="w-full bg-surface-container-low border border-outline-variant/50 text-slate-900 rounded-xl px-4 py-3 text-sm focus:border-primary outline-none transition-all">
                    </div>
                    <div>
                        ...
                        <input type="text" name="telefono_celular" value="<?= $telefono ?>" class="w-full bg-surface-container-low border border-outline-variant/50 text-slate-900 rounded-xl px-4 py-3 text-sm focus:border-primary outline-none transition-all">
                    </div>
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="regimen_fiscal" value="<?= $regimen ?>" class="w-full bg-surface-container-low border border-outline-variant/50 text-slate-900 rounded-xl px-4 py-3 text-sm focus:border-primary outline-none transition-all">
                    </div>
                </div>
            </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <div class="relative">
                                <select name="metodo_pago" class="w-full bg-surface-container-low border border-outline-variant/50 text-slate-900 rounded-xl pl-4 pr-10 py-3 text-sm appearance-none bg-none focus:border-primary outline-none transition-all">
                        ...
                        <div>
                            ...
                            <input type="text" name="uso_cfdi" value="<?= $uso_cfdi ?>" placeholder="Ej. G03 - Gastos en general" class="w-full bg-surface-container-low border border-outline-variant/50 text-slate-900 rounded-xl px-4 py-3 text-sm focus:border-primary outline-none transition-all">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="space-y-8">
            ...
            <div class="bg-surface-container-lowest border border-outline-variant/30 rounded-2xl p-6 ">
                ...
                <div class="space-y-3">
                    <button type="button" class="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-transparent border border-outline-variant hover:bg-slate-100 text-slate-800 text-sm font-semibold rounded-xl transition-colors" onclick="cambiarPassword()">
        ...
        html: `
            <div class="flex flex-col gap-4 text-left">
                <div>
                    ...
                    <input type="password" id="curr_pass" class="w-full bg-surface-container-low border border-outline-variant/50 text-slate-900 rounded-xl px-4 py-3 mt-1 text-sm outline-none focus:border-primary">
                </div>
                <div>
                    <label class="text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1">Nueva contraseña</label>
                    <input type="password" id="new_pass" class="w-full bg-surface-container-low border border-outline-variant/50 text-slate-900 rounded-xl px-4 py-3 mt-1 text-sm outline-none focus:border-primary">
                </div>
                <div>
                    <label class="text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1">Confirmar nueva contraseña</label>
                    <input type="password" id="conf_pass" class="w-full bg-surface-container-low border border-outline-variant/50 text-slate-900 rounded-xl px-4 py-3 mt-1 text-sm outline-none focus:border-primary">
                </div>
            </div>
        `,
