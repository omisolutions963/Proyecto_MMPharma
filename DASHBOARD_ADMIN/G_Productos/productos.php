...
<div class="flex justify-between items-end mb-8 animate-reveal">
  ...
  <div class="flex gap-3">
    <a href="categorias.php" class="bg-primary text-white px-6 py-3 rounded-xl flex items-center gap-2 font-bold shadow-lg shadow-primary/20 hover:opacity-90 transition-all">
