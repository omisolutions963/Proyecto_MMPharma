...
<main class="ml-64 mt-16 p-8 min-h-screen w-[calc(100%-16rem)]" style="background:#071628">
 ...
 ?>
 <!-- Card Dirección -->
 <div class="bg-surface-container-lowest border-2 <?= $dir['predeterminada'] ? 'border-primary/30 0_0_20px_rgba(74,144,217,0.05)]' : 'border-outline-variant/30 ' ?> rounded-2xl p-6 relative flex flex-col transition-all hover:border-primary/50 animate-reveal" style="animation-delay: <?= $idx * 0.1 ?>s">
 <div class="mb-4">
