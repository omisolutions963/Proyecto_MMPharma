...
<main class="ml-64 mt-16 p-8 min-h-screen w-[calc(100%-16rem)]" style="background:#071628">
 ...
 <div>
 <button type="button" class="px-6 py-3 bg-primary hover:bg-primary-fixed-dim text-white text-sm font-bold rounded-xl transition-all flex items-center gap-2" onclick="Swal.fire({icon:'info', title:'Próximamente', text:'Formulario de contacto en desarrollo.', background:'#071628', color:'#fff'})">
