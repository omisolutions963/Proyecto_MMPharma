...
<li class=""><a class="hover:text-white transition-colors" href="<?= $base ?? '' ?>INDEX/index.php">Inicio</a></li>
<li class=""><a class="hover:text-white transition-colors" href="<?= $base ?? '' ?>QUIENES_SOMOS/quienes_somos.php">Nosotros</a></li>
<li class=""><a class="hover:text-white transition-colors" href="<?= $base ?? '' ?>CATALOGO/catalogo.php">Catálogo</a></li>
<li class=""><a class="hover:text-white transition-colors" href="<?= $base ?? '' ?>CONTACTO/contacto.php">Contacto</a></li>
</ul>
</div>
<div>
<h4 class="font-bold text-lg mb-6">Legal</h4>
<ul class="space-y-4 text-blue-100/60 text-sm">
<li class=""><a class="hover:text-white transition-colors" href="#">Aviso de Privacidad</a></li>
<li class=""><a class="hover:text-white transition-colors" href="#">Términos y Condiciones</a></li>
<li class=""><a class="hover:text-white transition-colors" href="#">Cumplimiento COFEPRIS</a></li>
<li class=""><a class="hover:text-white transition-colors" href="#">Política de Devoluciones</a></li>
</ul>
</div>
<div>
...
<li class="flex items-start gap-3">
<span class="material-symbols-outlined text-secondary-container mt-1" data-icon="call">call</span>
                        <div class="flex flex-col gap-1">
                            <a href="tel:3322207506" class="hover:text-white transition-colors">33 2220 7506</a>
                            <a href="tel:3343480581" class="hover:text-white transition-colors">33 4348 0581</a>
                            <a href="tel:3343480582" class="hover:text-white transition-colors">33 4348 0582</a>
                        </div>
                    </li>
