<footer class="bg-black text-white pt-16 pb-16">
 ...
 <div class="flex gap-6">
  <a class="w-12 h-12 bg-white/5 rounded-full flex items-center justify-center hover:bg-white hover:text-black transition-all text-white" href="https://wa.me/523322207506" target="_blank" rel="noopener noreferrer" title="WhatsApp">
