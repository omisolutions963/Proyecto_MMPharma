<footer class="bg-primary text-white pt-16 pb-16">
 ...
 <a class="w-12 h-12 bg-white/5 rounded-full flex items-center justify-center hover:bg-white hover:text-primary transition-all text-white" href="mailto:atencionclientes@mmpharma.mx">
