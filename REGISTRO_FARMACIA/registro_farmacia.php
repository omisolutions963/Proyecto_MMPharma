 ...
 <div class="w-full bg-surface/85 backdrop-blur-xl text-slate-200 rounded-3xl border border-white/10 overflow-hidden relative shadow-2xl">
  ...
  <div class="p-8 md:p-12">
   <header class="mb-10 text-center">
    ...
    <h1 class="text-3xl font-black text-white tracking-tight mb-3">Registro de Farmacia</h1>
    ...
    <section>
     ...
     <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
      <div class="md:col-span-2">
       ...
       <input name="razon_social" class="w-full px-4 py-3 bg-background/50 border border-white/10 rounded-xl focus:ring-2 focus:ring-tertiary/20 focus:border-tertiary text-white text-sm transition-all placeholder:text-slate-500 outline-none" placeholder="Ej. Farmacia San Jorge S.A. de C.V." type="text" required>
      </div>
      <div>
       <label class="block text-xs font-semibold text-slate-300 mb-2">Nombre Comercial <span class="text-red-500">*</span></label>
       <input name="nombre_comercial" class="w-full px-4 py-3 bg-background/50 border border-white/10 rounded-xl focus:ring-2 focus:ring-tertiary/20 focus:border-tertiary text-white text-sm transition-all placeholder:text-slate-500 outline-none" placeholder="Ej. Farmacia San Jorge" type="text" required>
      </div>
      <div>
       <label class="block text-xs font-semibold text-slate-300 mb-2">RFC <span class="text-red-500">*</span></label>
       <input name="rfc" class="w-full px-4 py-3 bg-background/50 border border-white/10 rounded-xl focus:ring-2 focus:ring-tertiary/20 focus:border-tertiary text-white text-sm transition-all placeholder:text-slate-500 outline-none" placeholder="Ej. FSJ010101ABC" type="text" required>
      </div>
      <div class="md:col-span-2">
    ...
    <section>
     ...
     <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      <div class="md:col-span-3">
       ...
       <input name="email" class="w-full px-4 py-3 bg-background/50 border border-white/10 rounded-xl focus:ring-2 focus:ring-tertiary/20 focus:border-tertiary text-white text-sm transition-all placeholder:text-slate-500 outline-none" placeholder="ejemplo@farmacia.com" type="email" required>
      </div>
     </div>
    </section>
