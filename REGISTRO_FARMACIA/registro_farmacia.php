<?php
$titulo = 'MMPharma | Registro Farmacia';
...
<main class="max-w-4xl mx-auto px-4 py-8 md:py-12 flex-grow flex flex-col items-center w-full relative z-10">
 <div class="w-full bg-white text-slate-600 rounded-3xl border border-slate-100 overflow-hidden relative">
 ...
 <h1 class="text-3xl font-extrabold text-on-surface tracking-tight mb-3">Registro de Farmacia</h1>
 ...
 <input name="razon_social" class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-lg focus:ring-2 focus:ring-primary/20 focus:border-primary text-sm transition-colors" placeholder="Ej. Farmacia San Jorge S.A. de C.V." type="text" required>
 </div>
 <div>
 <label class="block text-xs font-semibold text-slate-600 mb-1.5">Nombre Comercial <span class="text-red-500">*</span></label>
 <input name="nombre_comercial" class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-lg focus:ring-2 focus:ring-primary/20 focus:border-primary text-sm transition-colors" placeholder="Ej. Farmacia San Jorge" type="text" required>
 </div>
 <div>
 <label class="block text-xs font-semibold text-slate-600 mb-1.5">RFC <span class="text-red-500">*</span></label>
 <input name="rfc" class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-lg focus:ring-2 focus:ring-primary/20 focus:border-primary text-sm transition-colors" placeholder="Ej. FSJ010101ABC" type="text" required>
 </div>
 <div class="md:col-span-2">
 ...
 <input name="email" class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-lg focus:ring-2 focus:ring-primary/20 focus:border-primary text-sm transition-colors" placeholder="ejemplo@farmacia.com" type="email" required>
 </div>
 </div>
 </section>
 ...
 <div class="text-xs font-semibold text-primary px-3 py-1 bg-white border border-slate-200 rounded-md ">Examinar</div>
 </div>
 </div>
 <?php endforeach; ?>
 ...
 <div class="pt-4">
 <button class="w-full py-4 bg-primary text-white font-bold rounded-xl hover:bg-secondary transition-all flex items-center justify-center gap-2 uppercase tracking-wide" type="submit">
