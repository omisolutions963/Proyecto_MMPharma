...
<main class="ml-64 p-8 min-h-screen" style="background:#051a10">
 ...
 <button onclick="abrirModalCat()" class="bg-primary text-white px-6 py-3 rounded-xl flex items-center gap-2 font-bold hover:opacity-90 transition-opacity">
 <span class="material-symbols-outlined">add</span> Nueva categoría
 </button>
 </div>

 <div class="bg-surface-container-lowest rounded-2xl border border-outline-variant/10 overflow-hidden max-w-2xl animate-reveal" style="animation-delay: 0.15s">
...
<div id="modalCat" class="fixed inset-0 z-[100] hidden items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
 ...
 <button type="submit" class="flex-1 py-3 bg-primary text-white text-xs font-bold rounded-xl ">Guardar</button>
 </div>
 </form>
 </div>
</div>
