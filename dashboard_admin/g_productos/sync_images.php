...
<div id="modalCustomSearch" class="fixed inset-0 z-[120] hidden items-center justify-center p-4 bg-black/80 backdrop-blur-md">
...
<script>
    ...
    function openCustomSearchModal(id, name) {
        ...
        document.getElementById('modalCustomSearch').classList.add('flex');
    }

    function closeCustomSearchModal() {
        document.getElementById('modalCustomSearch').classList.add('hidden');
        document.getElementById('modalCustomSearch').classList.remove('flex');
    }
