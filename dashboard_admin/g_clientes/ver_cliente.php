...
<div id="modalValidacion" class="fixed inset-0 z-[100] hidden items-center justify-center">
...
function abrirValidacion(doc) {
    ...
    document.getElementById('modalValidacion').classList.add('flex');
    setTimeout(() => {
...
function cerrarValidacion() {
    ...
    setTimeout(() => {
        ...
        document.getElementById('modalValidacion').classList.remove('flex');
    }, 300);
}
