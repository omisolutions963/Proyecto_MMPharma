...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
 ...
 <!-- Últimas solicitudes -->
 <div class="bg-surface-container-lowest rounded-2xl border border-outline-variant/10 overflow-hidden animate-reveal" style="animation-delay: 0.6s">
 ...
 foreach ($links as $l): ?>
 <a href="<?= $l['href'] ?>"
 class="flex flex-col items-center gap-2 p-4 rounded-xl transition-all hover:scale-105 hover: text-center"
