...
<aside id="adminSidebar" style="background:linear-gradient(180deg,#020d08 0%,#051a10 60%,#010a06 100%)"
 ...
 <span class="ml-auto flex h-5 w-auto min-w-[20px] px-1.5 items-center justify-center rounded-full bg-red-500 text-[10px] font-black text-white ">
...
<div id="cropperModalProfile" class="fixed inset-0 z-[110] hidden items-center justify-center p-4" style="background:rgba(0,0,0,0.8); backdrop-filter:blur(8px)">
...
function cerrarCropperProfile() {
  ...
  document.getElementById('cropperModalProfile').classList.remove('flex');
...
document.getElementById('fotoInput').addEventListener('change', function(e) {
 ...
 reader.onload = (event) => {
  ...
  document.getElementById('cropperModalProfile').classList.add('flex');
