...
<head>
 ...
 color: white;
 z-index: 10;
 box-: 0 10px 25px -5px rgba(22, 163, 74, 0.4);
...
<body class="bg-background text-on-surface antialiased min-h-screen flex flex-col items-center justify-center p-6">
 ...
 <div class="max-w-5xl w-full bg-surface rounded-3xl p-8 md:p-12 relative overflow-hidden">
 <!-- Accent top border -->
 ...
 <div class="w-16 h-16 rounded-full bg-success flex items-center justify-center border-4 border-white mb-4">
 ...
 <div class="w-16 h-16 rounded-full bg-success flex items-center justify-center border-4 border-white relative z-10 shrink-0">
 <span class="material-symbols-outlined text-white text-[28px]">task_alt</span>
 </div>
 <div class="pt-4">
 <h3 class="text-lg font-bold text-success">Solicitud enviada</h3>
 ...
 <div class="w-12 h-12 bg-white rounded-full flex items-center justify-center text-primary shrink-0 mt-1">
