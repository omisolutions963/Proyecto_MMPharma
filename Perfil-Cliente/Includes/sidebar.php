...
$menuItems = [
    ...
    ['icon' => 'person',          'label' => 'Mi Perfil',    'page' => 'perfil'],
    ...
    <div class="mt-auto pt-4 border-t border-white/10 flex flex-col gap-3 px-2">
        ...
        <div class="flex items-center gap-3 pt-2">
            ...
            <img src="<?= htmlspecialchars($fotoSide) ?>"
                 ...
                 alt="Perfil">
            <?php else: ?>
            <div class="w-9 h-9 rounded-full border border-blue-400/30 flex items-center justify-center text-white font-bold text-sm flex-shrink-0"
