...
<section class="relative min-h-[369px] flex items-center overflow-hidden bg-background">
 ...
 <img src="IMG/40.webp" class="w-full h-full object-cover opacity-20 parallax-bg scale-125 origin-top" data-speed="0.2">
...
<section class="py-24 bg-surface border-y border-white/5">
 ...
 <div class="absolute -bottom-6 -right-6 bg-background border border-white/5 p-8 rounded-xl hidden md:block">
 <div class="text-4xl font-black text-primary">+10</div>
 <div class="text-sm font-semibold text-slate-400 tracking-wide">años de trayectoria</div>
 </div>
 </div>
...
<!-- ── MISIÓN Y VISIÓN ── -->
<section class="py-24 bg-background text-white overflow-hidden">
 <div class="max-w-[1600px] mx-auto px-8">
...
<section class="py-32 bg-surface border-y border-white/5">
 ...
 <div class="group p-8 rounded-xl bg-background border border-white/5 transition-all duration-300 flex flex-col items-center text-center md:items-start md:text-left" data-aos="fade-up" data-aos-delay="100">
 <div class="w-16 h-16 bg-white/5 rounded-xl flex items-center justify-center mb-6 group-hover:bg-primary transition-colors duration-300">
 <span class="material-symbols-outlined text-4xl text-primary group-hover:text-background transition-colors duration-300">verified_user</span>
 </div>
 <h4 class="text-xl font-bold text-primary mb-3">Integridad</h4>
 <p class="text-sm text-slate-300 leading-relaxed font-medium">Transparencia absoluta en precios, inventarios y condiciones de entrega.</p>
 </div>
 <div class="group p-8 rounded-xl bg-background border border-white/5 transition-all duration-300 flex flex-col items-center text-center md:items-start md:text-left" data-aos="fade-up" data-aos-delay="200">
 <div class="w-16 h-16 bg-white/5 rounded-xl flex items-center justify-center mb-6 group-hover:bg-primary transition-colors duration-300">
 <span class="material-symbols-outlined text-4xl text-primary group-hover:text-background transition-colors duration-300">biotech</span>
 </div>
 <h4 class="text-xl font-bold text-primary mb-3">Precisión</h4>
 <p class="text-sm text-slate-300 leading-relaxed font-medium">Manejo cuidadoso de cadena de frío y entrega exacta de inventarios especializados.</p>
 </div>
 <div class="group p-8 rounded-xl bg-background border border-white/5 transition-all duration-300 flex flex-col items-center text-center md:items-start md:text-left" data-aos="fade-up" data-aos-delay="300">
 <div class="w-16 h-16 bg-white/5 rounded-xl flex items-center justify-center mb-6 group-hover:bg-primary transition-colors duration-300">
 <span class="material-symbols-outlined text-4xl text-primary group-hover:text-background transition-colors duration-300">handshake</span>
 </div>
 <h4 class="text-xl font-bold text-primary mb-3">Compromiso</h4>
 <p class="text-sm text-slate-300 leading-relaxed font-medium">Atención personalizada y lealtad total hacia nuestros socios comerciales.</p>
 </div>
 <div class="group p-8 rounded-xl bg-background border border-white/5 transition-all duration-300 flex flex-col items-center text-center md:items-start md:text-left" data-aos="fade-up" data-aos-delay="400">
 <div class="w-16 h-16 bg-white/5 rounded-xl flex items-center justify-center mb-6 group-hover:bg-primary transition-colors duration-300">
 <span class="material-symbols-outlined text-4xl text-primary group-hover:text-background transition-colors duration-300">memory</span>
 </div>
 <h4 class="text-xl font-bold text-primary mb-3">Innovación</h4>
 <p class="text-sm text-slate-300 leading-relaxed font-medium">Portal B2B propio con inventario en tiempo real y cotizaciones automatizadas.</p>
 </div>
 </div>
 </div>
</section>
...
<!-- ── CTA FINAL ── -->
<section class="pb-32 bg-surface relative overflow-hidden pt-0">
 <div class="max-w-[1600px] mx-auto px-12 relative z-10">
 <div class="bg-background rounded-[2rem] p-12 md:p-20 text-center border border-white/5 relative overflow-hidden group" data-aos="zoom-in">
 <div class="inline-flex items-center justify-center w-20 h-20 bg-surface rounded-3xl mb-8 group-hover:rotate-[360deg] transition-transform duration-700">
 ...
 <p class="text-slate-300 text-lg mb-12 max-w-2xl mx-auto font-medium leading-relaxed">
 Únete a la red de distribución farmacéutica más confiable de México. Contacta con nosotros hoy mismo.
 </p>
 <div class="flex flex-col sm:flex-row gap-6 justify-center items-center">
 <a href="contacto.php" class="px-8 md:px-12 py-5 bg-primary text-white font-bold rounded-xl hover:bg-secondary hover:-translate-y-1 transition-all text-base md:text-lg flex items-center gap-2 whitespace-nowrap">
 Contactar ahora
 </a>
 </div>
 </div>
