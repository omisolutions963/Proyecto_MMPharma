...
<div class="w-24 h-24 bg-primary/10 border border-primary/20 rounded-full flex items-center justify-center mb-6 group-hover:scale-110 group-hover:bg-primary transition-all duration-300">
<span class="text-2xl font-black text-primary group-hover:text-background transition-colors">01</span>
</div>
...
<div class="w-24 h-24 bg-primary/10 border border-primary/20 rounded-full flex items-center justify-center mb-6 group-hover:scale-110 group-hover:bg-primary transition-all duration-300">
<span class="text-2xl font-black text-primary group-hover:text-background transition-colors">02</span>
</div>
...
<div class="w-24 h-24 bg-primary/10 border border-primary/20 rounded-full flex items-center justify-center mb-6 group-hover:scale-110 group-hover:bg-primary transition-all duration-300">
<span class="text-2xl font-black text-primary group-hover:text-background transition-colors">03</span>
</div>
...
<div class="w-24 h-24 bg-primary/10 border border-primary/20 rounded-full flex items-center justify-center mb-6 group-hover:scale-110 group-hover:bg-primary transition-all duration-300">
<span class="text-2xl font-black text-primary group-hover:text-background transition-colors">04</span>
</div>
