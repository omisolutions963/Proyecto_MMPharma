<footer class="bg-[#050d18] border-t border-white/5 text-white py-16">
 ...
 <div class="flex justify-center gap-4">
   <a class="w-10 h-10 bg-white/5 rounded-full flex items-center justify-center hover:bg-white/10 transition-all hover:scale-110" href="https://wa.me/523322207506" target="_blank" rel="noopener noreferrer" title="WhatsApp">
